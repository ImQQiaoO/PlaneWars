...
public class SimpleGame extends GameEngine{
    ...
    public void init() {
        ...
        bulletList = new ArrayList<>(); // Store all friendly bullets in the game
    ...
    public void update(double dt) {
        ...
        bulletList.removeIf(bullet -> (bullet.getY() < -bullet.getHeight() / 2) || bullet.getY() > gameHeight + bullet.getHeight() / 2);
    }
    ...
    public void generateFriendlyBullets() {
        ...
        int bulletType = 1;
        bulletList.add(new Bullet(bulletX1, bulletY1, bulletVx, bulletVy, bulletWidth, bulletHeight, enemyImage, bulletType));
        if (PlayerPlane.playerNumber == 2) {
            ...
            bulletList.add(new Bullet(bulletX2, bulletY2, bulletVx, bulletVy, bulletWidth, bulletHeight, enemyImage, bulletType));
        }
    }
